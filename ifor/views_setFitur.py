...
from . import views, views_if_model
...
class SetFiturListView(ListView):
    model = SetFiturModel
    ordering = ['id']
    template_name = "ifor/setFitur/index.html"
...
class SetFiturCreateView(SuccessMessageMixin, CreateView):
    ...
    template_name = "ifor/setFitur/create.html"
    success_url = reverse_lazy('if:set-fitur-index')
    context_object_name = 'forms'
    fitur_terbaik = ['V14', 'V4', 'V17', 'V12', 'V11', 'V2',
                     'V10', 'V7', 'V20', 'V21', 'V19', 'V8',
                     'V6', 'V27', 'V3','V26','V9','Amount',
                     'V13','V15','V23','V22','V1','V24','V28',
                     'V18','V16','V25','V5','Time']
    best_fitur = {
        '3 Fitur Terbaik': fitur_terbaik[:3],
        '5 Fitur Terbaik': fitur_terbaik[:5],
        '7 Fitur Terbaik': fitur_terbaik[:7],
        '10 Fitur Terbaik': fitur_terbaik[:10],
    }
    # print(fitur_terbaik[:5])
    extra_context = {
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        if count_default_dataset == 1:
            ...
            # context['numfitur'] = len(fitur_terbaik)
    ...
    def form_valid(self, form):
        ...
        # X, y = views_if_model.get_x_y(df, get_label, get_fitur)
...
class SetFiturDetailView(DetailView):
    model = SetFiturModel
    template_name = "ifor/setFitur/detail.html"
