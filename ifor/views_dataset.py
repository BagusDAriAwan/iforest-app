...
class DatasetListView(ListView):
    model = DatasetModel
    ordering = ['id']
    template_name = "ifor/dataset/index.html"
    context_object_name = 'datasets'

    extra_context = {
        'page_judul': 'Tabel Dataset',
        'page_deskripsi': 'untuk mengelola Dataset Transaksi Kartu Kredit',
        'page_role': 'Dataset',
    }
...
class DatasetCreateView(SuccessMessageMixin, CreateView):
    ...
    template_name = "ifor/dataset/create.html"
    success_url = reverse_lazy('if:dataset-index')
...
class DatasetDetailView(DetailView):
    model = DatasetModel
    template_name = "ifor/dataset/detail.html"
