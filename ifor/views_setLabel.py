...
class SetLabelListView(ListView):
    model = SetLabelModel
    ordering = ['id']
    template_name = "ifor/setLabel/index.html"
...
class SetLabelCreateView(SuccessMessageMixin, CreateView):
    ...
    template_name = "ifor/setLabel/create.html"
    success_url = reverse_lazy('if:set-label-index')
...
class SetLabelUpdateView(SuccessMessageMixin, UpdateView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context['labelfraud'] = setlabel.nilai_label_fraud
...
class SetLabelDetailView(DetailView):
    model = SetLabelModel
    template_name = "ifor/setLabel/detail.html"
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context['X_shape'] = '"--pastikan mengisi nilai kolom label  &  nilai label kelas nilai_label_fraud dengan benar--"'
        context['count_label'] = '"--pastikan mengisi nilai kolom label &  nilai label kelas fraud dengan benar--"'
