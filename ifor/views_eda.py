...
def eksploreData(request):
    template_name = "ifor/eda/eksplore_data.html"
    context = {
...
def plot(request,list_fitur):
    template_name = "ifor/eda/plot.html"
    context = {
    ...
    if count_default_dataset == 1:
        ...
        if count_validate_label == 1:
            ...
            figure.savefig("ifor/static/random_forest/plot/swarm-box-plot.png")
...
def pca(request):
    ...
    template_name = "ifor/eda/pca.html"
    context = {
        'page_judul': 'Eksploratory Data Analysis',
        'page_deskripsi': 'untuk memperoleh pengetahuan awal mengenai data',
        'page_role': 'Dataset'
    ...
    if count_default_dataset == 1:
        ...
        if count_validate_label == 1:
          ...
          # create PCA----------------------------------------------------
            ...
            figure = plot.get_figure() 
            figure.savefig("ifor/static/random_forest/pca/pca.png")
